...
const bijvNw =
        ['tossing', 'bloody', 'shitting', 'wanking', 'stinky', 'raging', 'dementing', 'dumb', 'dipping', 'fucking', 'instant',
...
const combinations = [
  [bijvNw, gilles, object],
  [bijvNw, gilles, handelend],
  [bijvNw, object, handelend],
  [gilles, object],
  [gilles, handelend],
  [object, handelend],
  [bijvNw, gilles, object, handelend]
]
...
module.exports = function () {
  let combination = randomPick(combinations)
  return combination.map(c => randomPick(c)).join(' ').toUpperCase()
}
